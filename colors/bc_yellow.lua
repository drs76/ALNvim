...
-- ── Status / tab line ─────────────────────────────────────────────────────────
hi(0, "StatusLine",   { bg = "#04b925", fg = "#010704", bold = true })
hi(0, "StatusLineNC", { bg = "#023a0f", fg = "#04b925" })
...
hi(0, "alTypeSubtype",  { fg = "#9CDCFE" })  -- plain subtype name  (Record Customer → Customer)
hi(0, "alTypeSubtypeQ", { fg = "#9CDCFE" })  -- quoted subtype name (Record "Sales Header")
